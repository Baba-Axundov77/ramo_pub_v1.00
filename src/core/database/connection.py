...
def init_database():
    ...
    for attempt in range(max_retries):
        try:
            ...
            db_logger.info(f"Pool tənzimləmələri: {settings.database.get_pool_stats()}")
    ...
    try:
        ...
        from src.core.database.models import create_all_tables
        ...
        success_msg = (
            ...
            f"Connection Pool: {settings.database.get_pool_stats()}"
        )
