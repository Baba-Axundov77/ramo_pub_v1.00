...
from src.core.database.models import Customer, Discount, Order, OrderStatus
...
class LoyaltyService:
    ...
    def create_customer(
        ...
        try:
            ...
            db.rollback()
            return False, f"Müştəri yaradılarkən xəta: {str(e)}"
    ...
    def update_customer(
        ...
        try:
            ...
            db.rollback()
            return False, f"Müştəri yenilənərkən xəta: {str(e)}"
    ...
    def delete_customer(
        ...
        try:
            ...
            db.rollback()
            return False, f"Müştəri arxivlənərkən xəta: {str(e)}"
    ...
    def add_points(
        ...
        try:
            ...
            db.rollback()
            return False, f"Xal əlavə edilərkən xəta: {str(e)}"
    ...
    def redeem_points(
        ...
        try:
            ...
            db.rollback()
            return False, f"Xal istifadə edilərkən xəta: {str(e)}"
    ...
    def adjust_points(
        ...
        try:
            ...
            db.rollback()
            return False, f"Xal balansı yenilənərkən xəta: {str(e)}"
    ...
    def create_discount(
        ...
        try:
            ...
            db.rollback()
            return False, f"Endirim yaradılarkən xəta: {str(e)}"
    ...
    def update_discount(
        ...
        try:
            ...
            db.rollback()
            return False, f"Endirim yenilənərkən xəta: {str(e)}"
    ...
    def toggle_discount(
        ...
        try:
            ...
            db.rollback()
            return False, f"Endirim statusu dəyişdirilərkən xəta: {str(e)}"
    ...
    def delete_discount(
        ...
        try:
            ...
            db.rollback()
            return False, f"Endirim deaktiv edilərkən xəta: {str(e)}"
