...
class TokenManager:
    ...
    def __init__(self, secret_key: str = None):
        self.secret_key = secret_key or os.getenv("JWT_SECRET_KEY") or "dev_jwt_secret_key_32_chars_long_please"
        if not self.secret_key:
            self.secret_key = "dev_jwt_secret_key_32_chars_long_please"
