...
from src.core.modules.orders.workflow_service import order_workflow_service
from src.core.config import get_table_images_path
from src.web.auth import permission_required, permission_required_api

bp = Blueprint("tables", __name__, url_prefix="/tables")
svc = TableService()

UPLOAD_FOLDER = get_table_images_path()
