...
class TableCard(QFrame):
    ...
    def _build(self):
        ...
        from src.desktop.views.widgets.image_picker import RoundedImageLabel
    ...
    def _load_order_summary(self):
        ...
        try:
            ...
            if parent_view and hasattr(parent_view, 'db'):
                from src.core.database.models import Order
...
class AddTableDialog(QDialog):
    ...
    def _build(self):
        from src.desktop.views.widgets.image_picker import ImagePickerWidget, TABLE_IMGS
        v = QVBoxLayout(self)
        v.setSpacing(12)
        v.setContentsMargins(20, 20, 20, 20)
...
class TablesView(QWidget):
    ...
    def _update_ui_from_api_data(self, tables_data):
        ...
        from src.core.database.models import Table
        tables = []
